...
import LandingPageMap from "../maps/LandingPageMap";
...
interface LandingPagePropertiesProps {
  ...
  export default function LandingPageProperties({ apiData }: LandingPagePropertiesProps) {
            ...
            <Row>
              ...
              <Col className="cards">
                <Card className="site-card h-100 shadow-sm rounded-3">
                  ...
                  <Card.Body>
                    {/* <MapProvider>
                      <LandingPageMap apiData={apiData} />
                    </MapProvider> */}
                    <LandingPageMap />
                  </Card.Body>
                </Card>
