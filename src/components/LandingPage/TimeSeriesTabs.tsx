...
function TimeSeriesTabs({ apiData }: TimeSeriesPropertiesProps) {
  ...
  let data = variableSpecificObjects;
  ...
  return (
    <div className="tabs-chart">
      {Object(apiData).TotalSiteVariableAmountsCount > 0 ? <div className="download-button">{/* <Downloads apiData={apiData} /> */}</div> : <div></div>}
            ...
            <Table striped bordered className="tab-results">
              <thead className="tbl-header">
                <tr className="tr-header">
                  ...
                  <SortableHeader label="VariableSpecificTypeCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="VariableCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="AmountUnitCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="AggregationStatisticsCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="AggregationInterval" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="AggregationIntervalUnitCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="ReportYearStartMonth" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="ReportYearType" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="MaximumAmountUnitCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                </tr>
              </thead>
              <tbody>
                {displayItems().map(
        ...
        <div>
          <div>
            <Table striped bordered className="tab-results">
              <thead className="tbl-header">
                <tr className="tr-header">
                  <SortableHeader label="WaterSourceName" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="WaterSourceNativeID" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="WaterSourceUUID" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="WaterSourceTypeCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="FreshSalineIndicatorCV" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                  <SortableHeader label="WaterSourceGeometry" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                </tr>
              </thead>
              <tbody>
                {displayItems().map(
        ...
        <div>
          <div className="table-container">
            <Table striped bordered className="tab-results">
              <thead className="tbl-header">
                <tr className="tr-header">
                  <SortableHeader label="Water Right Native ID" sortBy={sortBy} sortOrder={sortOrder} onSortChange={handleSortChange} />
                </tr>
              </thead>
              <tbody>
                <tr>
